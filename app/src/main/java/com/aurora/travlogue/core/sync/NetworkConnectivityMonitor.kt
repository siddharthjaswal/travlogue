 ...
 * Provides a Flow of connectivity status that emits whenever connectivity changes
 */
class NetworkConnectivityMonitor(private val context: Context) {
     ...
     * Automatically unregisters callback when flow collection stops
     */
    val isConnected: Flow<Boolean> = callbackFlow {
        val callback = object : ConnectivityManager.NetworkCallback() {
            ...
            override fun onCapabilitiesChanged(
                ...
                // Only consider network available if it has internet and is validated
     ...
     * Useful for determining if large syncs should be performed
     */
