...
import com.aurora.data.data.entity.MESSAGES_TABLE_NAME
...
interface MessageDao {
     ...
     */
    @Query("SELECT * FROM $MESSAGES_TABLE_NAME WHERE session_id = :sessionId ORDER BY timestamp ASC")
     ...
     *
     * @param sessionId The ID of the chat session whose messages are to be deleted.
     * @return The number of messages deleted.
     */
    @Query("DELETE FROM $MESSAGES_TABLE_NAME WHERE session_id = :sessionId")
